CREATE DATABASE gamecreator

CREATE TABLE users (id UUID NOT NULL PRIMARY KEY, username VARCHAR(30) NOT NULL UNIQUE, password TEXT NOT NULL UNIQUE, email VARCHAR(100), date_of_birth DATE NOT NULL, time_of_signup TIMESTAMP NOT NULL);
CREATE TABLE gameData (id UUID NOT NULL PRIMARY KEY, game_name VARCHAR(50) NOT NULL UNIQUE, game_data jsonb, time_created TIMESTAMP NOT NULL, grid_image TEXT, likes INTEGER NOT NULL DEFAULT 0, plays INTEGER NOT NULL DEFAULT 0, user_id UUID NOT NULL REFERENCES users(id));
